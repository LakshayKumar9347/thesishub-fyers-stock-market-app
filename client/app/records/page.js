                                ...
                                <table className="table-auto w-full border bg-white shadow-md rounded-md">
                                    <thead className="bg-gray-800 text-white sticky top-0 z-50">
                                        <tr>
                                            ...
                                            {(recordStockDataCE || recordStockDataPE) != '' && <th className="px-4 py-2 text-center border">Symbols</th>}
                                        </tr>
                                    </thead>
                                    <tbody className="max-h-80 overflow-y-scroll">
                                        {spotLTP.map((value, index) => (
                                            <tr key={index}>
                                                ...
                                                <td className="px-4 py-2 text-center border">{recordStockDataCE === '' ? stockDataCE[index]?.v.lp : (recordStockDataCE[index][4])}</td>
                                                <td className="px-4 py-2 text-center border">{recordStockDataPE === '' ? stockDataPE[index]?.v.lp : (recordStockDataPE[index][4])}</td>
                                                {(recordStockDataCE || recordStockDataPE) != '' && <td className="px-4 py-2 text-center border">{comparisionSymbolMandT[index]}</td>}
                                            </tr>
                                        ))}
                                    </tbody>
                                </table>

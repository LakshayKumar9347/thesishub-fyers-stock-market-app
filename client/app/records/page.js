...
const Page = () => {
    ...
    const fetchRecordStockData = async (value) => {
        try {
            ...
            console.error('Error fetching Records Data From /Records');
        }
    }
    ...
    }, [selectedStrikePrice, index, symbol, timeUpdateDuration, recordStockDataCE, recordStockDataPE, selectedDate]);
    return (
        <>
            <Navbar />

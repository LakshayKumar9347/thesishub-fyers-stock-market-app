                ...
                <main className="container mx-auto mt-7 grow">
                    ...
                    <div className="table-container">
                        <div class="max-h-96 overflow-y-auto">
                            <table class="table-auto w-full border bord bg-white shadow-md rounded-md ">
                                <thead class="bg-gray-800 text-white sticky top-0 z-50">
                                    <tr>
                                        <th class="px-4 py-2 text-center border-r">Date</th>
                                        <th class="px-4 py-2 text-center border-r">Open Value</th>
                                        <th class="px-4 py-2 text-center border-r">Highest Value</th>
                                        <th class="px-4 py-2 text-center border-r">Lowest Value</th>
                                        <th class="px-4 py-2 text-center border-r">Close Value</th>
                                ...
                                <tbody>
                                    {!loading && stockData.map((rowData, index) => (
                                        <tr key={index} class="border">
                                            <td class="px-4 py-2 text-center border">{convertEpochToIndiaDate(rowData[0])}</td>
                                            <td class="px-4 py-2 text-center border-r">{rowData[1].toLocaleString('en-IN', {
                                                maximumFractionDigits: 2
                                            })}</td>
                                            <td class="px-4 py-2 text-center border-r">{rowData[2].toLocaleString('en-IN', {
                                                maximumFractionDigits: 2
                                            })}</td>
                                            <td class="px-4 py-2 text-center border-r">{rowData[3].toLocaleString('en-IN', {
                                                maximumFractionDigits: 2
                                            })}</td>
                                            <td class="px-4 py-2 text-center border-r">{rowData[4].toLocaleString('en-IN', {
                                                maximumFractionDigits: 2
                                            })}</td>
                    ...
                    <div className="container m-5 text-center flex justify-center">
                        {loading &&
                            <Loading />}
                    </div>
                </main>
